...
let requestCount = 0;
const MAX_REQUESTS_BEFORE_RESTART = 150; // Auto-restart browser to prevent memory leaks
...
app.post('/api/charge', async (req, res) => {
    ...
    try {
        ...
        if (proxyServer) {
            // Note: Puppeteer sets global proxy at launch; proxy-server argument handles node routing.
        }

        await page.setUserAgent('Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/123.0.0.0 Safari/537.36');
        
        // Block heavy assets to protect RAM and speed up checks
