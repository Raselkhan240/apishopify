...
app.post('/api/charge', async (req, res) => {
    ...
    try {
        ...
        // Disable images and CSS to make requests faster and prevent target crashes
        ...
        const prodRes = await page.goto(`${cleanSite}/products.json?limit=20`, { waitUntil: 'domcontentloaded', timeout: 30000 }).catch(() => null);
        if (!prodRes) {
            await browser.close();
        ...
        await page.goto(`${cleanSite}/checkout`, { waitUntil: 'domcontentloaded', timeout: 35000 }).catch(() => null);
