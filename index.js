...
app.post('/api/charge', async (req, res) => {
    ...
    try {
        ...
        // Increased timeout to 35000ms (35 seconds)
        const prodRes = await page.goto(`${cleanSite}/products.json?limit=20`, { waitUntil: 'domcontentloaded', timeout: 35000 });
        ...
        // Add product and go to checkout with extended timeout
        await page.goto(`${cleanSite}/cart/add?id=${selectedVariantId}&quantity=1`, { waitUntil: 'domcontentloaded', timeout: 35000 });
        await page.goto(`${cleanSite}/checkout`, { waitUntil: 'domcontentloaded', timeout: 40000 });
