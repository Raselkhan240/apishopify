...
app.post('/api/charge', async (req, res) => {
    ...
    try {
        ...
        // Setup response interception to catch payment gateway API results directly
        ...
        // Click the payment button and wait a few seconds for the network response to trigger
        ...
        // Wait up to 8 seconds to capture the network response from the processor evaluation
        for (let i = 0; i < 16; i++) {
        ...
        if (isRealSuccess) {
            ...
            // Extract a cleaner decline reason if available in the text
